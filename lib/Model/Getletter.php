 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class Getletter implements ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Getletter';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['mailbox_id'] === null) {
            $invalid_properties[] = "'mailbox_id' can't be null";
        }
